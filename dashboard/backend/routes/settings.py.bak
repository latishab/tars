...
def set_display_module(display):
    """Set reference to display module."""
...
async def set_emotion(request: EmotionRequest):
    ...
    try:
        _display_module.set_emotion(request.emotion)
...
async def set_eye_state(request: EyeStateRequest):
    ...
    try:
        _display_module.set_eye_state(request.state)
