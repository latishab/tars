...
(function () {
  ...
  // Rainbow color palette for prismatic effects
  var PRISM_COLORS = [
    { r: 255, g: 0,   b: 60  },  // red
  ...
  function createOrb() {
    return {
      ...
      hue: Math.random() < 0.6 ? 190 : (Math.random() < 0.5 ? 280 : 320), // cyan, purple, or magenta
  ...
  function draw() {
    ...
    for (var k = 0; k < particles.length; k++) {
      ...
      ctx.fillStyle = 'rgba(0, 229, 255, ' + (p.alpha * 0.7) + ')';
      ctx.fill();
    }
  }
