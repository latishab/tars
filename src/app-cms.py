#!/usr/bin/env python3
"""
TARS Configuration Management System V3
Author: Charles-Olivier Dion (AtomikSpace)
Contact: atomikspace.labs@gmail.com
Copyright (c) 2026 Charles-Olivier Dion

This tool synchronizes config.ini with config.ini.template for
TARS. It preserves user-configured values while adding new
fields/sections from template updates.

IMPORTANT: This tool does NOT modify servo calibration values!
Always use app-servotester.py for servo calibration.
...
╚══════════════════════════════════════════════════════════════⠞⠁⠗⠎═════╝
        ...
        print("TARS: ⚠ Servo values will NOT be modified (use app-servotester.py for that)")
        time.sleep(0.5)
