            ...
            if star['z'] < 0.52:
                ...
                for i in range(segments):
                    ...
                    if fade > 0.7:
                        ...
                        mix = (0.7 - fade) / 0.3
                        r_c = int(brightness * (1.0 - mix * 0.3))
                        g_c = int(brightness * (1.0 - mix * 0.15))
                        b_c = brightness
                        seg_color = (r_c, g_c, b_c)
                    else:
                        darken = (0.4 - fade) / 0.4
                        r_c = int(brightness * (0.7 - darken * 0.7))
                        g_c = int(brightness * (0.85 - darken * 0.85))
                        b_c = int(brightness * (1.0 - darken))
                        seg_color = (r_c, g_c, b_c)
