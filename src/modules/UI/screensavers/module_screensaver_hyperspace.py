...
class HyperspaceAnimation:
    ...
    def _create_lanes(self):
        ...
        for i in range(num_lanes):
            ...
            lanes.append({'bottom_x': bottom_x, 'top_x': top_x})
        return lanes
    ...
    def render(self):
        ...
        for trail in self.trails:
            ...
            for i in range(len(trail['history']) - 1):
                ...
                if (start_pos[0] < -50 and end_pos[0] < -50) or                    (start_pos[0] > self.width + 50 and end_pos[0] > self.width + 50):
                    continue
