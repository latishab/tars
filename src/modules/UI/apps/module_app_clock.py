...
class ClockApp:
    def __init__(self, screen, width, height):
        ...
        try:
            self.font_large = pygame.font.Font(str(_UI_DIR / "mono.ttf"), 48)
            self.font_medium = pygame.font.Font(str(_UI_DIR / "mono.ttf"), 24)
            self.font_small = pygame.font.Font(str(_UI_DIR / "mono.ttf"), 16)
        except Exception:
